        ...
        <div className='mt-5'>
          {songData?.sections[1].type === 'LYRICS' ?
            songData.sections[1].text.map((line, i) => (
              <p key={i} className='rounded-lg p-1 m-0 text-gray-400 text-base my-1 smooth-transition hover:scale-110 hover:translate-x-8 hover:bg-blue hover:bg-[#4c426e]'>{line}</p>
